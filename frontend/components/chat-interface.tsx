...
export function ChatInterface({ onQuestionSubmit, isCompact }: ChatInterfaceProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const matchedQuestion = demoData.demo_questions.find((q) => q.prompt.toLowerCase() === inputValue.toLowerCase())
    ...
    if (matchedQuestion) {
      ...
      setTimeout(() => {
        const assistantMessage: ChatMessage = {
          ...
          type: "assistant",
          content: "I found relevant data for your query. Check the report panel for detailed analysis.",
          timestamp: new Date(),
        }
      ...
      const assistantMessage: ChatMessage = {
        id: (Date.now() + 1).toString(),
        type: "assistant",
        content: "I'm sorry, I don't recognize that question. Please try one of the suggested demo questions.",
        timestamp: new Date(),
      }
        ...
        {messages.length === 0 && !isCompact && (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center py-12">
            ...
            <p className="text-muted-foreground mb-8 max-w-md mx-auto">
              Ask questions about Argo ocean float data and get interactive visualizations and analysis.
            </p>

            {/* Demo Question Suggestions */}
            <div className="space-y-3 max-w-2xl mx-auto">
              <p className="text-sm font-medium text-foreground mb-4">Try these demo questions:</p>
